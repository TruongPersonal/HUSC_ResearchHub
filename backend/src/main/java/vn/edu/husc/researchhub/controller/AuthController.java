...
import vn.edu.husc.researchhub.dto.request.UpdateProfileRequest;
...
public class AuthController {
    ...
    public ResponseEntity<vn.edu.husc.researchhub.dto.response.UserResponse> updateProfile(
        ...
        vn.edu.husc.researchhub.dto.response.UserResponse response = userService.updateProfile(username, request, avatar);
        return ResponseEntity.ok(response);
    }

    @PostMapping(value = "/update-avatar", consumes = org.springframework.http.MediaType.MULTIPART_FORM_DATA_VALUE)
