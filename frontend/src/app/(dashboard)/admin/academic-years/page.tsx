...
/**
 * Trang Quản lý Năm học.
 * Hiển thị danh sách năm học, hỗ trợ tìm kiếm, lọc theo trạng thái, và phân trang.
 * Cho phép thêm mới hoặc chỉnh sửa năm học.
 */
export default function AcademicYearsPage() {
  ...
  return (
    <div className="h-full flex-1 flex-col space-y-8 md:flex">
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Danh sách các năm học hệ thống.
          </p>
        </div>
      ...
      <AcademicYearTable data={data} onEdit={handleEdit} />
