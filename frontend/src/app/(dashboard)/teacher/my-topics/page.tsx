...
/**
 * Trang "Đề tài của tôi" dành cho Giảng viên.
 * Hiển thị danh sách các đề tài mà Giảng viên tham gia với vai trò: Trưởng nhóm (nếu có), Thành viên, hoặc Giảng viên hướng dẫn.
 */
    ...
    <div className="max-w-[1080px] mx-auto pb-12">
      ...
      <Tabs defaultValue="proposals" className="space-y-6">
        ...
        >
          <MyTopicsTable
            data={proposals}
            onView={(topic: MyTopic) =>
              router.push(`/teacher/my-topics/${topic.id}?view=proposal`)
            }
        ...
        >
          <MyTopicsTable
            data={topics}
            onView={(topic: MyTopic) =>
              router.push(`/teacher/my-topics/${topic.id}?view=topic`)
            }
