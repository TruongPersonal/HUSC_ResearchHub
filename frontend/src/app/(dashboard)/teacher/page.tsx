 ...
 * Hiển thị Banner giới thiệu và Thông tin hướng dẫn (HeroSection, InfoSection).
 * Cung cấp liên kết nhanh đến danh sách đề tài và thông báo.
 */
  ...
  return (
    <div className="relative w-full max-w-[1080px] mx-auto min-h-[65vh] flex flex-col justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <InfoSection
          topicsHref="/teacher/topic-registration"
