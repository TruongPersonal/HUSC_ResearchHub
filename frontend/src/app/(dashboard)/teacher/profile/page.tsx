...
export default function TeacherProfilePage() {
    ...
    const handleUpdate = async (next: Profile): Promise<boolean> => {
        ...
        try {
            ...
            const combinedDegree = [rankString, degreeString].filter(Boolean).join(" ");
            ...
            if (updatedUser.academicDegree) {
                ...
                if (updatedUser.academicDegree.includes("PGS")) updatedRank = "Phó Giáo sư";

                if (updatedUser.academicDegree.includes("CN")) updatedDegree = "Cử nhân";
                if (updatedUser.academicDegree.includes("ThS")) updatedDegree = "Thạc sĩ";
                if (updatedUser.academicDegree.includes("TS")) updatedDegree = "Tiến sĩ";
                if (updatedUser.academicDegree.includes("TSKH")) updatedDegree = "Tiến sĩ khoa học";
            }
                ...
                <Card className="border-dashed border-2 border-gray-200 bg-gray-50/50 shadow-none">
                    <CardContent className="flex flex-col items-center justify-center py-16 text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">Không thể tải thông tin người dùng.</p>
                        </div>
                    </CardContent>
                </Card>
            ) : (
