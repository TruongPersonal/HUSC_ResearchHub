...
/**
 * Trang Đề xuất đề tài dành cho Sinh viên.
 * Form đăng ký đề tài mới khi có đợt (Session open).
 * Validate dữ liệu đầu vào (Kinh phí, Số từ...) và gửi request đề xuất.
 */
      ...
      <div className="mb-8 flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Đề xuất đề tài nghiên cứu khoa học.
          </p>
        </div>
