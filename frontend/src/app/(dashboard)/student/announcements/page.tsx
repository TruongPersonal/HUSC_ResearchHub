...
import { AnnouncementDetailModal, Noti } from "@/features/announcements/components/AnnouncementDetailModal";
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const response = await announcementService.getAll(undefined, currentPage, ITEMS_PER_PAGE, selectedYear?.id);

                // Map API response to UI model
                const mappedData: Noti[] = response.content.map((item: Announcement) => ({
                    id: item.id,
                    title: item.title,
        ...
        <div className="max-w-[1080px] mx-auto">
            ...
            <div className="mb-8 flex items-end justify-between">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Danh sách các thông báo từ Khoa và hệ thống.</p>
                </div>
