...
export default function ApprovedTopicsPage() {
    ...
    const [data, setData] = useState<PageResponse<ApprovedTopicResponse> | null>(null);
    const [currentPage, setCurrentPage] = useState(0);
    const pageSize = 10

    const [selectedTopic, setSelectedTopic] = useState<ApprovedTopicResponse | null>(null);
    ...
    const [statusFilter, setStatusFilter] = useState<ApprovedTopicStatus | "ALL">("ALL")
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900">Quản lý đề tài</h1>
