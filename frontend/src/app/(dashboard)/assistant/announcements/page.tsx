...
/**
 * Trang Quản lý Thông báo của Khoa (dành cho Trợ lý).
 * Hiển thị danh sách thông báo thuộc khoa của người dùng hiện tại.
 * Hỗ trợ thêm, sửa, xóa thông báo trong phạm vi khoa.
 */
      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Danh sách các thông báo của khoa.
          </p>
        </div>
