...
/**
 * Badge hiển thị trạng thái của Đề tài đã duyệt.
 * Các trạng thái: Đang thực hiện, Hoàn thành, Không hoàn thành, Đã huỷ.
 */
export function ApprovedTopicStatusBadge({
  status,
}: ApprovedTopicStatusBadgeProps) {
