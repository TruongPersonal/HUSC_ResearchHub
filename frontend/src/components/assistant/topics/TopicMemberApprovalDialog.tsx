...
export function TopicMemberApprovalDialog({ open, onOpenChange, topic, onSuccess }: TopicMemberApprovalDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-md">
                ...
                <div className="mb-2 text-lg font-semibold text-[#0b57a8]">{topic.title}</div>
