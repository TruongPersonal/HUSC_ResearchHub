...
/**
 * Section nhập nội dung chi tiết cho đề xuất đề tài.
 * Bao gồm các Editor cho: Mục tiêu, Nội dung, Sản phẩm dự kiến, v.v.
 */
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-xs ${objectiveWords > maxWords ? "text-red-500 font-bold" : "text-gray-400"}`}
            >
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-xs ${contentWords > maxWords ? "text-red-500 font-bold" : "text-gray-400"}`}
            >
