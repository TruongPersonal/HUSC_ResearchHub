...
export default function Informations<T extends Record<string, any>>({
    ...
    return (
        <div className={cn("bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative", className)}>
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex flex-col items-center space-y-6 border-b border-gray-100 pb-10">
                        ...
                        <div className="text-center space-y-2">
                            <h3 className="text-2xl font-bold text-gray-900">{String(data.name || "User")}</h3>
                            <div className="flex items-center justify-center gap-2">
                                <span className={cn("text-sm font-medium px-3 py-1 rounded-full", roleLabel === "Giảng viên" ? "text-green-600 bg-green-50" : "text-blue-600 bg-blue-50")}>
                                    {roleLabel || "Sinh viên"}
                                </span>
                            ...
                            {fields.map((field) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={cn(
                                            field.colSpan === "full" ? "md:col-span-2" : "md:col-span-1"
                                        )}
                                    >
