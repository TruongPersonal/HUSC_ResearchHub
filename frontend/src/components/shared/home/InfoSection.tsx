...
/**
 * Section thông tin giới thiệu trên trang chủ.
 * Hiển thị các block thông tin về quy trình, lợi ích, v.v.
 */
    ...
    <div className="space-y-8 pt-4">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg text-gray-600 leading-relaxed max-w-lg">
          Nền tảng trực tuyến hỗ trợ sinh viên đăng ký và quản lý đề tài nghiên
          cứu khoa học. Đơn giản hóa quy trình, kết nối giảng viên và sinh viên
          hiệu quả.
        </p>
      </div>
