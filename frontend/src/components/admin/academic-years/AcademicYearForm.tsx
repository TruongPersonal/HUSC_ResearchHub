...
const formSchema = z.object({
  year: z.coerce
    .number()
    .min(2000, "Năm phải lớn hơn 2000")
...
/**
 * Form tạo/chỉnh sửa Năm học.
 * Bao gồm các trường: Năm, Trạng thái (Bắt đầu/Kết thúc), Kích hoạt.
 */
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            {initialData ? "Chỉnh sửa năm học" : "Thêm năm học mới"}
          </DialogTitle>
          <DialogDescription>
            {initialData
              ? "Cập nhật thông tin năm học."
              : "Tạo năm học mới cho hệ thống."}
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
