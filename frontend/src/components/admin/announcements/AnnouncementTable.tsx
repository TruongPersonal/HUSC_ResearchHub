...
/**
 * Bảng quản lý Thông báo (cho Admin).
 * Các cột: Tiêu đề, Nội dung (rút gọn), Ngày đăng, Thao tác.
 */
      ...
      <Table>
        <TableHeader className="bg-gray-50">
          <TableRow>
            ...
            <TableHead className="text-right font-semibold text-gray-700 w-[100px]">
              Thao tác
            </TableHead>
          </TableRow>
        </TableHeader>
