...
const formSchema = z.object({
    ...
    if (data.role === "ASSISTANT" && (!data.departmentId || data.departmentId === "0")) {
        return false
    }
    return true
}, {
    message: "Trợ lý khoa bắt buộc phải chọn khoa",
    path: ["departmentId"],
})
...
export function UserForm({ open, onOpenChange, initialData, onSubmit }: UserFormProps) {
    ...
    const handleSubmit = async (values: z.infer<typeof formSchema>) => {
        const submitData = {
            ...values,
            departmentId: values.departmentId && values.departmentId !== "0" ? parseInt(values.departmentId) : undefined
        }
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {initialData ? "Cập nhật thông tin người dùng." : "Tạo người dùng mới cho hệ thống."}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="nvtrung / 23t102..." {...field} disabled={!!initialData} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                                    ...
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value} value={field.value}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="ASSISTANT">Trợ lý viên</SelectItem>
