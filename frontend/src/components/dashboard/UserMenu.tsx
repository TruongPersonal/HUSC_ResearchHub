...
const ROLE_META: Record<
    UserRole,
    { label: string; defaultAvatar: string }
> = {
    ADMIN: {
        label: "Quản trị viên",
...
export function UserMenu() {
    ...
    const [user, setUser] = useState<{ username: string; role: UserRole; fullName?: string; avatarUrl?: string } | null>(null)
    ...
    return (
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-[260px] rounded-xl shadow-lg p-2">
                    <DropdownMenuItem
