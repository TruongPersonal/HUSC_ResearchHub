...
import { ArrowRight, FileText, CheckCircle2, CalendarDays, Loader2 } from "lucide-react"
...
export function AssistantStatsGrid({ stats, loading }: AssistantStatsGridProps) {
