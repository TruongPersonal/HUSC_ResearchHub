...
export function UserProfileDialog({ open, onOpenChange, user, onUserUpdated }: UserProfileDialogProps) {
        ...
        try {
            ...
            if (oldPassword || password) {
                ...
                if (!oldPassword || !password) {
                    ...
                    toast.error("Vui lòng nhập đầy đủ mật khẩu cũ và mới để đổi mật khẩu")
                    return
                }
            ...
            const message = error.response?.data?.message || error.response?.data || "Cập nhật thất bại"
            toast.error(message)
        }
    }
            ...
            <DialogContent className="w-[420px] rounded-2xl p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 mt-4">
                    <div className="flex flex-col gap-4">
                        ...
                        {(user.role !== "ADMIN" && user.role !== "ASSISTANT") && (
                            <div className="space-y-2">
                                <Label className="text-sm font-medium text-gray-700">Đổi mật khẩu</Label>
                                <div className="flex gap-3">
                                    <div className="relative flex-1">
                                        ...
                                        >
                                            {showOldPwd ? <EyeOff className="w-3 h-3" /> : <Eye className="w-3 h-3" />}
                                        </button>
                                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <Button type="submit" className="rounded-lg bg-primary hover:bg-primary/90">
                            Lưu thay đổi
                        </Button>
                    </div>
                </form>
