...
export function EditSummaryDialog({ open, onOpenChange, documentId, initialSummary, onSuccess }: EditSummaryDialogProps) {
            ...
            <DialogContent>
                ...
                <div className="space-y-4 py-2">
                    <div className="space-y-2">
                        <span className="text-sm font-medium">Tóm tắt bài báo <span className="text-red-500">*</span></span>
                        <Textarea
