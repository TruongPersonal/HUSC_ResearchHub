...
/**
 * Bảng hiển thị danh sách đề tài của tôi (Giảng viên/Sinh viên).
 * Hiển thị các cột: Mã, Tên đề tài, Vai trò, Trạng thái.
 */
      ...
      <Table>
        <TableHeader className="bg-gray-50/80">
          <TableRow className="hover:bg-gray-50/80 border-gray-100">
            {showCode && (
              <TableHead className="w-28 font-semibold text-gray-600">
                Mã
              </TableHead>
            )}
        ...
        <TableBody>
          {data.map((topic) => (
            ...
            >
              ...
              <TableCell>
                <span
                  className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium border ${topic.role === "LEADER"
