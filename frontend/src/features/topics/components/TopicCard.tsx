...
import { User, Calendar, ArrowRight, BookOpen, CheckCircle2, XCircle, Clock } from "lucide-react";
...
export function TopicCard({ topic, onViewDetails, onRegister, isSessionOpen, showAction = true }: TopicCardProps) {
                ...
                <div className="flex items-center gap-3 w-full md:w-auto mt-2 md:mt-0">
                    ...
                    {isSessionOpen && showAction && (
                        <Button
                            ...
                            onClick={() => !topic.isApproved && !topic.isPending && !topic.isRejected && onRegister(topic)}
                            disabled={!!topic.isApproved || !!topic.isPending || !!topic.isRejected}
                        >
                            {topic.isApproved ? (
                                <>
