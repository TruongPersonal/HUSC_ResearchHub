...
import { Clock, CheckCircle2, XCircle, AlertCircle, PlayCircle, StopCircle, AlertTriangle } from "lucide-react";
...
export function StatusBadge({ status, className: externalClassName }: StatusBadgeProps) {
    ...
    return (
        <Badge variant="outline" className={`${className} ${externalClassName || ''} gap-1.5 py-1 px-2.5`}>
