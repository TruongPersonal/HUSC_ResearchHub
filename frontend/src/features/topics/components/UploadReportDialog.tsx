...
export function UploadReportDialog({ open, onOpenChange, topicId, reportType, initialSummary, onSuccess }: UploadReportDialogProps) {
    ...
    const handleUpload = async () => {
        ...
        setUploading(true);
        try {
            await approvedTopicService.uploadDocument(topicId, file, reportType.id, summary);
            ...
            <DialogContent>
                ...
                <div className="space-y-4 py-4">
                    <div className="space-y-2">
                        <label className="text-sm font-medium">Chọn file ({isPresentation ? "PowerPoint" : "Word"})</label>
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Định dạng cho phép: {isPresentation ? ".pptx, .ppt" : ".docx, .doc"}
                        </p>
                    </div>

                    {isScientificArticle && (
                        <div className="space-y-2">
                            <Label>Tóm tắt bài báo <span className="text-red-500">*</span></Label>
                            <Textarea
