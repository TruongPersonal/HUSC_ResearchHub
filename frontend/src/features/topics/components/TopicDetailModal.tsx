 ...
 * Bao gồm: Tên, Mã, Mô tả, GVHD, Sinh viên thực hiện.
 */
                ...
                {topic.students && topic.students.length > 0 ? (
                  <div className="bg-purple-50 rounded-lg border border-purple-100 flex flex-col gap-1 p-2">
                    {topic.students.map((student) => (
                      <div
                        key={student.id}
                        className="p-2 flex items-center justify-between rounded-md"
                      >
                        <div className="flex items-center gap-2">
                          {student.isLeader ? (
                          ...
                          <span
                            className={`text-sm ${student.isLeader ? "font-bold text-purple-900" : "font-medium text-purple-800"}`}
                          >
                            {student.name}
                          </span>
                        </div>
