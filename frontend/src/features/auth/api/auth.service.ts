...
export const authService = {
    ...
    updateProfile: async (data: UpdateProfileRequest, avatar?: File): Promise<User> => {
        ...
        if (data.course !== undefined) formData.append("course", data.course.toString());
        if (data.className !== undefined) formData.append("className", data.className);
        if (data.academicDegree !== undefined) formData.append("academicDegree", data.academicDegree);
